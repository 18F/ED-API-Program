The below is a set of requirements that can be applied to a new API project.  The list, or some parts of it, can be included in a contract to build in useful requirements for an API project.  
